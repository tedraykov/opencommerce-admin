  ...
  const columns = useMemo<Column<Order>[]>(() => [
    ...
    },
    {
      ...
      accessor: (row) => row.payments[0]?.billingAddress?.fullName
        || row.fulfillmentGroups[0]?.data?.shippingAddress?.fullName,
      id: "customer",
      disableFilters: true
    },
    {
      ...
      accessor: (row) => {
        console.log(row);
        return row.payments[0]?.billingAddress?.postal
          || row.fulfillmentGroups[0]?.data?.shippingAddress?.postal
      },
      id: "postal",
      disableFilters: true
    },
    {
      ...
      accessor: (row) => row.payments[0]?.billingAddress?.city
        || row.fulfillmentGroups[0]?.data?.shippingAddress?.city,
      id: "city",
      disableFilters: true
    },
    {
